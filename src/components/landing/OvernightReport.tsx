...
export function OvernightReport() {
  return (
    <section className="relative z-10 mx-auto w-full max-w-[1240px] px-5 sm:px-6">
      ...
      <div className="grid gap-4.5 pb-10 sm:grid-cols-3">
        {CARDS.map((card, i) => (
          ...
          >
            ...
            <span className="mt-3.5 inline-block text-xs font-semibold tracking-wide text-primary-soft">
              {card.tagline}
            </span>
          </Reveal>
        ))}
